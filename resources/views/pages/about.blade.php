@extends('layouts/default',['title'=>'Abort'])
    @section('content')
        <div class="container">
            ...
            <p>Laracarte is a clone of <a href="http://laramap.com" target="_blank">Laramap.com</a></p>
            <div class="row">
                <div class="col-md-l">
                ...
                <p>feel free to help to improve the<a href="https://github.com/Tchangang-franck/laracarte"> source code</a></p>
            </div>
            <hr class="divider">
            <h2>What is laramap</h2>
            <p>Laramap is the  wesbsite by which Laracarte was inspire :).</p>
            More infore <a href="http://laramap.com/p.about">here.</a>
            <hr class="divider">
            <h2>Which tool ans services  are use in Laracarte ?</h2>
